"""
Simple test to verify fletching bot stores options in self.options.
...
print("=" * 60)
print("Testing Fletching Bot Options Persistence")
print("=" * 60)
...
# Test 3: Check that save_options processes fletching_method
print("\nTest 3: save_options() processes 'fletching_method' option")
if (
    'elif option == "fletching_method":' in content
    and "self.fletching_method = options[option]" in content
):
    print("PASSED: save_options correctly sets self.fletching_method")
else:
    print("FAILED: save_options doesn't properly handle fletching_method")
    sys.exit(1)
...
print("=" * 60)
print("\nThe fletching bot code is correctly structured to persist options.")
print("\nHow it works:")
...
print("5. New bot now has correct fletching_method and running_time!")
