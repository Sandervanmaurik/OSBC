...
class TemplateMixin:
    ...
    def _define_item_templates(self: "BotProtocol") -> Dict[str, TemplateSpec]:
        """
    ...
    def get_templates(
        self: "BotProtocol", method_key: str, **kwargs
    ) -> Tuple[str, ...]:
        """
    ...
    def _get_template_category(self: "BotProtocol", filename: str) -> Optional[str]:
        """
    ...
    def validate_templates(self: "BotProtocol", method_key: str, **kwargs) -> bool:
        """
